  ...
  return (
    <PrimaryLayout column="col-m-6" className="w-25">
      ...
      <p>
        ...
        in Rochester, New York on November 5, 1942. Neil's first childhood home
        was on Ok Terrace in Rochester. He attended Brighton Elementary School.
        He later moved to 74 Fort Hill Ave in Canandaigua New York. Neil won a
        National Merit Scholarship at Canandaigua Academy in 1959. 
      </p>
      <p>TODO: Add kid photo here.</p>
      <h2>Early Radio in Upstate New York (1959-1963)</h2>
      <p>
      ...
      <p>
        <em>
          ...
          Show December 30, 1997 @64:20, March 1, 2005 @1:15:15)
        </em>
      </p>
      <h2>Michigan Radio (1964-1973)</h2>
      ...
      <h2>Sarasota, FL (1973)</h2>
      <p>
        WSPB 1450 (Sarasota, FL) - According to the Miami Herald, this is where
        Neil began his talk radio career.
      </p>
      <blockquote>
        In 1973, Rogers moved to Sarasota, where quite by accident he did his
        first talk radio show. The station hired a retiree from Pittsburgh to do
        a talk show, but on his first day, the fellow couldn't figure out to
        work the phone and his guest didn't show up. The second day, the
      ...
      <h2>West Palm Beach (1975)</h2>
      <p>Bill Calder hired Neil to work at WJNO 1290 (Palm Beach, FL)</p>
      <p>
        <em>(Source: Miami Herald Tropic 624-0191, April 28, 1985)</em>
      </p>
      <h2>Neil Begins Miami Broadcasting in Miami (1976)</h2>
      <p>
      ...
      <p>TODO: Gay article</p>
      <h2>Neil Rogers Nutrition (1977)</h2>
      <p>
        Neil owned a health food store called Neil Rogers Nutrition in San
        Souci.
      </p>
      <p>TODO: Nutrition photo</p>
      <p>
      ...
      <h2>Miami Hurricanes Baseball (1978-1983)</h2>
      <p>
        Neil did play-by-play for Miami Hurricanes baseball (1978-1982 on radio
        and 1983 on TV).
      </p>
      <p>TODO:WNWS photo</p>
      <p>University of Miami Baseball (May 31, 1982) TODO: link to YT</p>
      <p>
        <em>
          (Sources: WNWS SWITCHES SIGNS ON UM (May 22, 1982), Neil Rogers Show
          July 30, 1999)
        </em>
      </p>
      <h2>To Nashville and Back to Miami in One Month (1980)</h2>
      <p>
